...
| ADR | 标题 | 状态 | 日期 |
|-----|------|------|------|
| [ADR-001](/decisions/001-ws-auth) | WebSocket 认证方案 | ✅ 已采纳 | 2025-01 |
| [ADR-002](/decisions/002-token-rotation) | Token Rotation 策略 | ✅ 已采纳 | 2025-01 |
| [ADR-003](/decisions/003-distributed-sync) | 分布式消息同步 | ✅ 已采纳 | 2025-02 |
...
1. 阅读 [协作指南](https://github.com/LessUp/chatroom/blob/master/AGENTS.md)
2. 创建 Issue 讨论
3. 提交 ADR 文档
