...
**阅读材料**:
- [架构文档](/zh/architecture/system) - 整体架构概览
- `cmd/server/main.go` - 启动流程与依赖装配
...
**阅读材料**:
- `internal/ws/` 目录
- [架构文档 - WebSocket 层](/zh/architecture/system#websocket-层)
...
**阅读材料**:
- `deploy/` 目录
- [GitHub 上的 deploy 目录](https://github.com/LessUp/chatroom/tree/master/deploy)
...
参照 [快速开始](/zh/tutorials/local-dev) 完成环境搭建。
...
1. [快速开始](/zh/tutorials/local-dev) — 5 分钟启动项目
2. [手动测试实验](/zh/tutorials/testing) — 验证核心功能
3. [API 文档](/zh/api/rest) — 理解接口设计
4. [架构文档](/zh/architecture/system) — 系统分层与数据流
5. [监控指南](/zh/tutorials/deployment) — 运行与观测面
