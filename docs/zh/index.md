...
features:
  ...
  - icon: ⚡
    ...
    link: /zh/architecture#websocket-层
    linkText: 了解架构
  - icon: 📊
    title: Prometheus 监控
...
1. [快速开始](/zh/getting-started) — 5 分钟启动项目
2. [手动测试实验](/zh/manual-testing) — 验证核心功能
3. [API 文档](/zh/api) — REST + WebSocket 接口
4. [架构文档](/zh/architecture) — 系统分层与数据流
5. [设计文档](/zh/design) — 设计决策与扩展方向
6. [常见问题](/zh/faq) — 问题解答
