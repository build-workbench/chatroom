...
**阅读材料**:
- [架构文档](/architecture/system) - 整体架构概览
...
**阅读材料**:
- `internal/ws/` 目录
- [架构文档 - WebSocket 层](/architecture/system#websocket-层)
...
参照 [快速开始](/tutorials/local-dev) 完成环境搭建。
...
1. [快速开始](/tutorials/local-dev) — 5 分钟启动项目
2. [手动测试实验](/tutorials/testing) — 验证核心功能
3. [API 文档](/api/rest) — 理解接口设计
4. [架构文档](/architecture/system) — 系统分层与数据流
5. [监控指南](/tutorials/deployment) — 运行与观测面
